...
type Client interface {
	...
	// For funds held under a Polymarket proxy / smart-wallet flow, set req.Funder to that address and the same
	// signature_type the site uses for your account (often 3 / POLY1271 with funder), or use WithFunder on the client.
