...
// resolveNegRisk fetches whether the outcome token uses the NegRisk CTF Exchange V2 domain for EIP-712.
// Without a transport client, signing uses the standard exchange domain (false).
func (b *OrderBuilder) resolveNegRisk(ctx context.Context, tokenID string) bool {
