...
// WithProxyURL sets an HTTP(S) proxy for outbound HTTP and WebSocket traffic when using
// the default HTTP client and default CLOB/RTDS WebSocket clients. Per-service configs
// set via WithCLOBWSConfig / WithRTDSConfig keep their own ProxyURL when already set.
// Example: polymarket.WithProxyURL("http://127.0.0.1:15236")
